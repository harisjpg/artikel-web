...
$id = $_GET['id'];
$ambil = $conn->query("SELECT * FROM tb_artikel WHERE id_artikel = '$id'");
        ...
        <div class="page-content">
            <div class="container">
                <div class="pp-section pp-container-readable">
                    <?php
                    $ambil = $conn->query("SELECT * FROM tb_artikel WHERE kategori = '$id' ORDER BY id_artikel DESC");

                    while ($print = $ambil->fetch_assoc()) {
                    ?>
